  ...
  render() {
    ...
    return (
      <div style={{ minHeight: '100vh', background: '#050505', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', fontFamily: 'Outfit, sans-serif' }}>
        <div style={{ width: '100%', maxWidth: '520px', padding: '32px', borderRadius: '24px', background: '#171717', border: '1px solid rgba(196,139,159,0.35)', textAlign: 'center' }}>
          <div style={{ color: '#c48b9f', fontSize: '36px', marginBottom: '12px' }}>?</div>
          ...
          <button onClick={() => this.setState({ showDebug: !this.state.showDebug })} style={{ border: '1px solid #555', borderRadius: '8px', padding: '6px 14px', background: 'transparent', color: '#c48b9f', fontWeight: 700, cursor: 'pointer', fontSize: '12px', marginBottom: '16px' }}>
          ...
          {this.state.showDebug && (
            <div style={{ textAlign: 'left', background: '#0a0a0a', borderRadius: '12px', padding: '16px', marginBottom: '16px', fontSize: '12px', fontFamily: 'monospace', color: '#ff6b6b', maxHeight: '300px', overflow: 'auto', wordBreak: 'break-all' }}>
              <div style={{ color: '#c48b9f', fontWeight: 800, marginBottom: '8px' }}>Error:</div>
              <div style={{ marginBottom: '12px' }}>{errorMsg}</div>
              {errorStack && (
                <>
                  <div style={{ color: '#c48b9f', fontWeight: 800, marginBottom: '8px' }}>Stack:</div>
                  <div style={{ color: '#888', whiteSpace: 'pre-wrap' }}>{errorStack}</div>
                </>
              )}
              <button onClick={this.handleCopyError} style={{ marginTop: '10px', border: '1px solid #555', borderRadius: '6px', padding: '4px 10px', background: 'transparent', color: '#c48b9f', fontWeight: 700, cursor: 'pointer', fontSize: '11px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <button onClick={this.handleReload} style={{ border: 0, borderRadius: '12px', padding: '12px 20px', background: '#c48b9f', color: '#050505', fontWeight: 900, cursor: 'pointer' }}>
              Recuperar pantalla
            </button>
