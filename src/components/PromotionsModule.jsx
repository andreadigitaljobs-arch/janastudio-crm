    ...
    <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'minmax(300px, 420px) 1fr', gap: 20 }}>
      <section className="agenda-glass-card" style={{ padding: 20 }}><h3 style={{ marginTop: 0 }}><Plus size={16}/> Nueva promoción</h3>
        <div style={{ display: 'grid', gap: 12 }}>
          ...
          <div style={{ padding:'10px 12px', borderRadius:12, background:'rgba(201,114,130,.07)', color:'var(--text-secondary)', fontSize:12 }}>La promoción se activa en caja durante su vigencia. La mensajería se configurará en una fase posterior.</div>
